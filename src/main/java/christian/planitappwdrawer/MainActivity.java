...
public class MainActivity extends AppCompatActivity
        ...
        FragmentEditEvent.OnFragmentInteractionListener, FragmentHomePage.OnFragmentInteractionListener, FragmentGroupPage.OnFragmentInteractionListener
        , FragmentAccountInfo.OnFragmentInteractionListener, FragmentGroupSchedule.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Navigating to Event Creator", Snackbar.LENGTH_LONG)
